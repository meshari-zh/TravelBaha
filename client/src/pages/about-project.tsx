  ...
  const milestones = [
    {
      ...
      descEn: "The project started by identifying a real problem: the difficulty for visitors to reach tour guides in AlBaha region, which led to the idea of creating an electronic platform that brings together guides and displays their services in an easy and clear way."
    },
    {
      stepAr: "٢",
      stepEn: "2",
    ...
    },
    {
      ...
      descEn: "A collection of tourist sites in AlBaha region was added to the platform, with: images, descriptions, geographic locations, and brief information for each site."
    },
    {
      stepAr: "٧",
      stepEn: "7",
