                        ...
                        <div className="text-center p-3 min-w-[250px]">
                          ...
                          <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
                            <div className="flex items-center justify-center gap-2 mb-2">
                              ...
                              <span className="font-semibold text-blue-800">{language === 'ar' ? 'المسافة من الباحة' : 'Distance from Al Bahah'}:</span>
                            </div>
                        ...
                        <div className="text-center p-3 min-w-[250px]">
                          ...
                          <div className="bg-green-50 p-3 rounded-lg border border-green-200">
                            <div className="flex items-center justify-center gap-2 mb-2">
                              ...
                              <span className="font-semibold text-green-800">{language === 'ar' ? 'المسافة من الباحة' : 'Distance from Al Bahah'}:</span>
                            </div>
