...
export default function JoinGuide() {
  ...
  const texts = language === 'ar' ? {
    ...
    pageSubtitle: 'Be part of our team and help tourists discover the beauty of AlBaha region',
    
    mainDesc: 'Do you have a passion for tourism and deep knowledge of AlBaha region? Join our team of professional guides and help tourists discover the beauty of the region.',
    whyJoin: 'Why Join Us?',
    ...
    reason4: 'Contributing to tourism development in AlBaha region',
