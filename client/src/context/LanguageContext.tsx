...
const translations = {
  ...
  en: {
    ...
    // Homepage
    welcomeTitle: 'Discover the Beauty of Al Baha',
    welcomeSubtitle: 'An unforgettable tourist journey in the heart of Saudi Arabia',
    welcomeDescription: 'Embark on an exceptional adventure and explore the stunning natural landscapes and rich culture of Al Baha region with our specialized local guides',
    ...
    placesSubtitle: 'Natural beauty and history in Al Baha',
    ...
    // About page
    aboutTitle: 'About Us',
    aboutSubtitle: 'A comprehensive tourism platform for Al Baha region',
    ourMission: 'Our Mission',
    ourMissionText: 'We aim to connect tourists with local guides to provide an authentic and distinctive tourism experience in Al Baha region',
    ourVision: 'Our Vision',
    ourVisionText: 'To be the leading tourism platform in Al Baha region and Saudi Arabia',
    ...
    // Map
    mapTitle: 'Al Baha Interactive Map',
    mapSubtitle: 'Explore the Beauty of Al Baha Region',
    mapDescription: 'Browse roads and tourist attractions with modern interactive technology',
    interactiveMap: 'Interactive Map',
    mapGuide: 'Map Guide',
    albahaCenter: 'Al Baha (Central Region)',
    meccaCity: 'Mecca',
    riyadhCity: 'Riyadh',
    touristPlaces: 'Tourist Places',
    albahaToMeccaRoad: 'Al Baha - Mecca Road',
    albahaToRiyadhRoad: 'Al Baha - Riyadh Road',
    touristPlacesInAlbaha: 'Tourist Places in Al Baha',
    distanceFromAlbaha: 'Distance from Al Baha',
    estimatedArrivalTime: 'Estimated Arrival Time',
    getDirections: 'Get Directions via Google Maps',
    viewOnGoogleMaps: 'View on Google Maps',
    albahaCapital: 'Capital of Al Baha Region',
