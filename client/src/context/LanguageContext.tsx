...
const translations = {
  ...
  en: {
    ...
    // Homepage
    welcomeTitle: 'Discover the Beauty of AlBaha',
    welcomeSubtitle: 'An unforgettable tourist journey in the heart of Saudi Arabia',
    welcomeDescription: 'Embark on an exceptional adventure and explore the stunning natural landscapes and rich culture of AlBaha region with our specialized local guides',
    ...
    placesSubtitle: 'Natural beauty and history in AlBaha',
    ...
    // About page
    aboutTitle: 'About Us',
    aboutSubtitle: 'A comprehensive tourism platform for AlBaha region',
    ourMission: 'Our Mission',
    ourMissionText: 'We aim to connect tourists with local guides to provide an authentic and distinctive tourism experience in AlBaha region',
    ourVision: 'Our Vision',
    ourVisionText: 'To be the leading tourism platform in AlBaha region and Saudi Arabia',
    ...
    mapGuide: 'Map Guide',
    albahaCenter: 'AlBaha (Central Region)',
    meccaCity: 'Mecca',
    riyadhCity: 'Riyadh',
    touristPlaces: 'Tourist Places',
    albahaToMeccaRoad: 'AlBaha - Mecca Road',
    albahaToRiyadhRoad: 'AlBaha - Riyadh Road',
    touristPlacesInAlbaha: 'Tourist Places in AlBaha',
    distanceFromAlbaha: 'Distance from AlBaha',
    estimatedArrivalTime: 'Estimated Arrival Time',
    getDirections: 'Get Directions via Google Maps',
    viewOnGoogleMaps: 'View on Google Maps',
    albahaCapital: 'Capital of AlBaha Region',
