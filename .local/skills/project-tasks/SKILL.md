...
| `recommendedModelProfile` | str | No | Model profile recommended for running the task: `economy` for routine, well-scoped work; `power` for complex or ambiguous work. Defaults to `economy`. |
