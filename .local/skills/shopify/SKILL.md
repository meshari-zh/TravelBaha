...
1. Propose the Shopify Store integration if this Repl has no Shopify Store connection assigned. The `shopify-store` connector is **app-scoped** — a connection belongs to exactly one Repl.
