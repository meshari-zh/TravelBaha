...
4. **Integrations:** For AI, use **AI Integrations** from the
   `## Integrations` directory (OpenAI / Anthropic / Gemini env vars
   ...
   check the `## Integrations` directory (or `searchIntegrations` when that list is absent from your instructions) first. Only fall back to
